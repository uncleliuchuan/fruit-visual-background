...
import com.jclz.fruit.youmeng.android.*;
...
public class Demo {
    ...
    public void sendIOSCustomizedcast() throws Exception {
        ...
        // And if you have many alias, you can also upload a file containing these alias, then
        // use file_id to send customized notification.
        customizedcast.setAlias("12", "JingChengUnited");
        customizedcast.setAlert("IOS 个性化测试");
        customizedcast.setBadge(0);
        customizedcast.setSound("default");
        // TODO set 'production_mode' to 'true' if your app is under production mode
        customizedcast.setTestMode();
        customizedcast.setCustomizedField("test", "helloworld");
    ...
    public static void main(String[] args) {
        ...
        String appkey = "5d1335c2570df30123000729";
        String appMasterSecret = "zeixg7sryol2j9as6bv7objdqb3utw3s";
